...
$keyBindingsPage = [pscustomobject]@{
    ...
    Chapters = @(
        [pscustomobject]@{ Id = 'USING'; Header = 'LOC_CAI_PEDIA_KEY_BINDINGS_USING_TITLE'; Content = @('LOC_CAI_PEDIA_KEY_BINDINGS_COMMON', 'LOC_CAI_PEDIA_KEY_BINDINGS_HELP', 'LOC_CAI_PEDIA_KEY_BINDINGS_FOCUSED_WIDGET_READER', 'LOC_CAI_PEDIA_KEY_BINDINGS_NAVIGATION', 'LOC_CAI_PEDIA_KEY_BINDINGS_ACTIVATION', 'LOC_CAI_PEDIA_KEY_BINDINGS_CONTEXT') },
...
$widgetPages = @(
    ...
    [pscustomobject]@{ Id = 'GRAPH'; Title = 'LOC_CAI_PEDIA_WIDGET_GRAPH_TITLE'; Content = @('LOC_CAI_PEDIA_WIDGET_GRAPH_FUNCTION', 'LOC_CAI_PEDIA_WIDGET_GRAPH_KEYS', 'LOC_CAI_PEDIA_WIDGET_GRAPH_SEARCH') },
...
$widgetFamilies = @(
    ...
    [pscustomobject]@{
        ...
        Widgets = @($widgetPages | Where-Object Id -in @(
            'PANEL', 'SEARCHPANEL', 'DIALOG', 'LIST', 'SUBMENU', 'TREE', 'GRAPH',
