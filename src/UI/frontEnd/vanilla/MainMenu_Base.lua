...
-- Global for accessibility mod
m_subOptionIM = InstanceManager:new( "MenuOption", "Top", Controls.SubMenuOptionStack );
...
-- Global for accessibility mod
m_currentOptions = {};		--Track which main menu options are being displayed and selected. Indices follow the format of {optionControl:table, isSelected:boolean}
